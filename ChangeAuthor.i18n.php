...
*$2 - page title',
	...
	'changeauthor-logentry' => 'The log message for author changes.
*$1 is the page title
*$2 includes {{msg-mw|changeauthor-rev}} in the site language
*$3 is the old author
*$4 is the new author',
...
$messages['de'] = array(
	...
	'changeauthor-desc' => 'Ermöglicht das Ändern des Autors einer Version',
	...
	'changeauthor-explanation-multi' => 'Mit diesem Formular kannst du den Autor mehrerer Versionen ändern. Ändere einfach den Namen einer oder mehrerer Autoren in der Liste, ergänze einen Kommentar (optional) und klicke dann auf die Schaltfläche „Autoren ändern“.',
	'changeauthor-changeauthors-single' => 'Autor ändern',
	'changeauthor-explanation-single' => 'Mit diesem Formular kannst du den Autor einer Version ändern. Ändere einfach den Namen des Autoren in der Liste, ergänze einen Kommentar (optional) und klicke dann auf die Schaltfläche „Autor ändern“.',
	'changeauthor-invalid-username' => 'Der Benutzername „$1“ ist ungültig.',
	'changeauthor-nosuchuser' => 'Es gibt keinen Benutzer namens „$1“.',
	'changeauthor-revview' => 'Version $1 von $2',
	'changeauthor-nosuchtitle' => 'Es gibt keine Seite namens „$1“.',
	'changeauthor-weirderror' => 'Ein sehr seltener Fehler ist aufgetreten. Bitte wiederhole deine Änderung. Sofern dieser Fehler erneut auftritt, liegt es vermutlich an einer fehlerhaften Datenbank.',
	'changeauthor-invalidform' => 'Bitte benutze das auf der [[Special:ChangeAuthor|Spezialseite]] bereitgestellte Formular.',
	'changeauthor-success' => 'Deine Änderung wurde erfolgreich durchgeführt.',
	'changeauthor-logentry' => 'änderte den Autor der $2 von Seite $1 von $3 zu $4',
...
$messages['de-formal'] = array(
	'changeauthor-explanation-multi' => 'Mit diesem Formular können Sie den Autor mehrerer Versionen ändern. Ändern Sie einfach den Namen einer oder mehrerer Autoren in der Liste, ergänzen Sie einen Kommentar (optional) und klicken Sie dann auf die Schaltfläche „Autoren ändern“.',
	'changeauthor-explanation-single' => 'Mit diesem Formular können Sie den Autor einer Version ändern. Ändern Sie einfach den Namen des Autoren in der Liste, ergänzen Sie einen Kommentar (optional) und klicken Sie dann auf die Schaltfläche „Autor ändern“.',
	'changeauthor-weirderror' => 'Ein sehr seltener Fehler ist aufgetreten. Bitte wiederholen Sie Ihre Änderung. Sofern dieser Fehler erneut auftritt, liegt es vermutlich an einer fehlerhaften Datenbank.',
	'changeauthor-invalidform' => 'Bitte benutzen Sie das auf der [[Special:ChangeAuthor|Spezialseite]] bereitgestellte Formular.',
 ...
 */
$messages['diq'] = array(
	'changeauthor' => 'Nuskarê çımraviyarnayışi bıvurnên',
	'changeauthor-desc' => 'Vurnayışê nuskarê de çımraviyarnayışi rê mısade dano',
	'changeauthor-title' => 'Nuskarê yew çımraviyarnayışi bıvurnên',
	'changeauthor-search-box' => 'Çımraviyarnayışan cı geyrên',
	'changeauthor-pagename-or-revid' => 'Nameyê pele ya zi kamiya çımraviyarnayışi:',
	'changeauthor-pagenameform-go' => 'Şo',
	'changeauthor-comment' => 'Vatış:',
	'changeauthor-changeauthors-multi' => '{{PLURAL:$1|Nuskari|Nuskaran}} bıvurnên',
	'changeauthor-explanation-multi' => 'Ebe nê formi ra şıma şenê nuskaranê çımraviyarnayışi bıvurnên.
Lista cêrene de tenya nameyê yewi ya zi zehf karberan bıvurnên, yew mışewre ilawe kerên (ixtıyari) u gecega "Nuskari (nuskaran) bıvurnên" bıtıknên.',
	'changeauthor-changeauthors-single' => 'Nuskari bıvurnên',
	'changeauthor-explanation-single' => 'Ebe nê formi ra şıma şenê yew nuskarê çımraviyarnayışi bıvurnên.
Cêr tenya nameyê karberi bıvurnên, yew mışewre ilawe kerên (ixtıyari) u gecega "Nuskari bıvurnên" bıtıknên.',
	'changeauthor-invalid-username' => '"$1" nameyê karberê nêvêrdey.',
	'changeauthor-nosuchuser' => 'Karbero de zey "$1" çıniyo.',
	'changeauthor-revview' => '$2 ra #$1 çım ra viyarnayış',
	'changeauthor-nosuchtitle' => '"$1" name dı pele çıniya.',
	'changeauthor-weirderror' => 'Xetê da zehf ğeribe amê meydan.
Kerem kerên, waştışê xo anciya bıcerebnên.
Na xeta ke hewna asena, beno ke bıngehê melumati biyo xırabe.',
	'changeauthor-logpagename' => 'Qeydê vurnayış dê nuskari',
);
...
$messages['frp'] = array(
	...
	'changeauthor-invalid-username' => 'Nom d’usanciér « $1 » envalido.',
	'changeauthor-nosuchuser' => 'Gins d’usanciér « $1 ».',
 ...
 */
$messages['ga'] = array(
	'changeauthor-pagenameform-go' => 'Gabh',
...
$messages['gl'] = array(
	...
	'changeauthor-pagenameform-go' => 'Continuar',
	'changeauthor-comment' => 'Comentario:',
 ...
 */
$messages['ja'] = array(
	'changeauthor' => '版の投稿者の変更',
	'changeauthor-desc' => '版の投稿者を変更できるようにする',
	'changeauthor-title' => '版の投稿者の変更',
	'changeauthor-search-box' => '版の検索',
	'changeauthor-pagename-or-revid' => 'ページ名または版ID:',
	'changeauthor-pagenameform-go' => '検索',
	'changeauthor-comment' => '変更理由:',
	'changeauthor-changeauthors-multi' => '{{PLURAL:$1|投稿者}}を変更',
	'changeauthor-explanation-multi' => 'このフォームでは、各版の投稿者を変更できます。
下記の一覧の利用者名を変更して、コメントを記入して (省略可能)、「投稿者を変更」ボタンを押してください。',
	'changeauthor-changeauthors-single' => '投稿者を変更',
	'changeauthor-explanation-single' => 'このフォームでは、版の投稿者を変更できます。
下記の利用者名を変更して、コメントを記入して (省略可能)、「投稿者を変更」ボタンを押してください。',
	'changeauthor-invalid-username' => '「$1」は無効な利用者名です。',
	'changeauthor-nosuchuser' => '利用者「$1」は存在しません。',
	'changeauthor-revview' => '$2 の版 #$1',
	'changeauthor-nosuchtitle' => '「$1」というページはありません。',
	'changeauthor-weirderror' => '予測不能なエラーが発生しました。
もう一度操作してください。
それでもエラーが発生する場合は、データベースが壊れているおそれがあります。',
	'changeauthor-invalidform' => '独自のフォームではなく、[[Special:ChangeAuthor|特別ページ]]が提供するフォームを使用してください。',
	'changeauthor-success' => '要求された処理を実行しました。',
	'changeauthor-logentry' => '$1 の$2 の投稿者を $3 から $4 に変更しました',
 ...
 */
$messages['ka'] = array(
	'changeauthor-pagenameform-go' => 'მიდი',
	'changeauthor-comment' => 'კომენტარი:',
);
 ...
 */
$messages['ko'] = array(
	'changeauthor' => '판의 저자 바꾸기',
	'changeauthor-desc' => '특정 판의 저자를 바꿀 수 있는 기능',
	'changeauthor-title' => '특정 판의 저자 바꾸기',
	...
	'changeauthor-changeauthors-multi' => '{{PLURAL:$1|저자}} 바꾸기',
	'changeauthor-explanation-multi' => "아래의 양식을 이용해 특정 판의 저자를 바꿀 수 있습니다.
아래 목록에서 바꾸려는 부분의 저자를 편집한 다음에, 이유를 입력하고 '저자 바꾸기'를 클릭하세요.",
	'changeauthor-changeauthors-single' => '저자 바꾸기',
	'changeauthor-explanation-single' => "아래의 양식을 이용해 특정 판의 저자를 바꿀 수 있습니다.
저자를 바꾼 다음, 이유를 입력하고 '저자 바꾸기'를 클릭해 주세요.",
	...
	'changeauthor-success' => '요청이 성공적으로 처리되었습니다.',
	'changeauthor-logentry' => '$1 문서의 $2를 $3 사용자에서 $4 사용자로 바꿈',
	'changeauthor-logpagename' => '저자 바꾸기 기록',
	'right-changeauthor' => '특정 판의 작성자 이름을 바꾸기',
);
 ...
 */
$messages['mt'] = array(
	'changeauthor' => 'Biddel l-awtur tar-reviżjoni',
	'changeauthor-desc' => "Jippermetti li tbiddel l-awtur ta' reviżjoni",
	'changeauthor-title' => "Biddel l-awturi ta' reviżjoni",
	'changeauthor-search-box' => 'Fittex reviżjonijiet',
	'changeauthor-pagename-or-revid' => 'Isem tal-paġna jew ID tar-reviżjoni:',
	'changeauthor-pagenameform-go' => 'Mur',
	'changeauthor-comment' => 'Kumment:',
	'changeauthor-changeauthors-multi' => 'Biddel l-{{PLURAL:$1|awtur|awturi}}',
	'changeauthor-explanation-multi' => "B'din il-formola inti tista' tbiddel l-awturi ta' reviżjonijiet.
Biddel biss wieħed jew iktar ismijiet tal-utent fil-lista t'hawn taħt, żid kumment (jekk tarah utli) u klikkja fuq il-buttuna \"Biddel l-awtur\".",
	'changeauthor-changeauthors-single' => 'Biddel l-awtur',
	'changeauthor-explanation-single' => "B'din il-formola inti tista' tbiddel l-awtur ta' reviżjoni.
Biddel biss l-isem tal-utent hawn taħt, żid kumment (jekk tarah utli) u klikkja fuq il-buttuna \"Biddel l-awtur\".",
	'changeauthor-invalid-username' => 'Isem tal-utent "$1" invalidu.',
	'changeauthor-nosuchuser' => 'L-ebda utent ma jeżisti bl-isem "$1".',
	'changeauthor-revview' => "Reviżjoni #$1 ta' $2",
	'changeauthor-nosuchtitle' => 'M\'hemm l-ebda paġna jisimha "$1".',
	'changeauthor-weirderror' => "Inqalgħet problema stramba.
Jekk jogħġbok ipprova ibgħat ir-rikjesta tiegħek.
Jekk dan l-iżball jibqa' jintwera, id-databażi hija probabbilment miksura.",
	'changeauthor-invalidform' => 'Jekk jogħġbok uża l-formola preżenti fil-[[Special:ChangeAuthor|paġna speċjali]] minflok dik personalizzata.',
	'changeauthor-success' => "Ir-rikjesta tiegħek ġiet proċessata b'suċċess.",
	'changeauthor-logentry' => "Imbiddel l-awtur ta' $1 ta' $2 minn $3 għal $4",
	'changeauthor-logpagename' => 'Reġistru tal-bidla fl-awturi',
	'right-changeauthor' => "Ibiddel l-awtur ta' reviżjoni",
);
 ...
 */
$messages['si'] = array(
	'changeauthor' => 'සංශෝධක කතෘ වෙනස් කරන්න',
	'changeauthor-search-box' => 'සංශෝධන සොයන්න',
	'changeauthor-pagenameform-go' => 'යන්න',
	'changeauthor-comment' => 'පරිකථනය:',
	'changeauthor-changeauthors-single' => 'කතෘ වෙනස් කරන්න',
	'changeauthor-invalid-username' => 'වකන්ගු නොවන පරිශීලක නාමය "$1".',
	'changeauthor-nosuchuser' => '"$1" පරිශීලකයෙකු නැත.',
	'changeauthor-logpagename' => 'කතෘ වෙනස්කිරීම් ලඝු සටහන',
);
...
$messages['ta'] = array(
	...
	'changeauthor-invalid-username' => 'செல்லாத பயனர் பெயர்  "$1".',
	'changeauthor-nosuchuser' => '"$1" என்று ஒரு பயனர் இல்லை.',
	'changeauthor-nosuchtitle' => '"$1" என்று ஒரு பக்கம் இல்லை.',
	'changeauthor-weirderror' => 'பெரிய பிழை ஒன்று நிகழ்ந்து விட்டது. 
தயவுசெய்து வேண்டுகோளை மறுபடியும் முயற்சிக்கவும்.
இதே பிழை மறுபடி மறுபடி வருமாயின், உங்கள் தரவுத்தளம் முறிந்திருக்க வாய்ப்புள்ளது.',
	'changeauthor-success' => 'உங்கள் வேண்டுகோள் வெற்றிகரமாகச் செயல்படுத்தப்பட்டது.',
);
 ...
 */
$messages['ur'] = array(
	'changeauthor-pagenameform-go' => 'جانا',
	'changeauthor-comment' => 'تبصرہ:',
	'changeauthor-changeauthors-single' => 'تبدیلی کے مصنف',
);
